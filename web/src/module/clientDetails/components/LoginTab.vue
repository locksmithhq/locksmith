  ...
  <v-row no-gutters>
    <v-col cols="12" lg="4" md="5" class="pa-0 pr-md-6">
      ...
      >
        ...
        <v-expansion-panel elevation="0" border rounded="lg" class="mb-3">
          <v-expansion-panel-title class="py-3">
            <v-icon color="primary" class="mr-3">mdi-login-variant</v-icon>
            <span class="font-weight-bold">Social Providers</span>
          </v-expansion-panel-title>
          <v-expansion-panel-text>
            <!-- Google -->
            <v-card variant="outlined" rounded="lg" class="pa-4 mb-3">
              <div class="d-flex align-center mb-3">
                <svg width="20" height="20" viewBox="0 0 24 24" class="mr-2" style="flex-shrink: 0">
                  <path fill="#4285F4" d="M22.56 12.25c0-.78-.07-1.53-.2-2.25H12v4.26h5.92c-.26 1.37-1.04 2.53-2.21 3.31v2.77h3.57c2.08-1.92 3.28-4.74 3.28-8.09z"/>
                  <path fill="#34A853" d="M12 23c2.97 0 5.46-.98 7.28-2.66l-3.57-2.77c-.98.66-2.23 1.06-3.71 1.06-2.86 0-5.29-1.93-6.16-4.53H2.18v2.84C3.99 20.53 7.7 23 12 23z"/>
                  <path fill="#FBBC05" d="M5.84 14.09c-.22-.66-.35-1.36-.35-2.09s.13-1.43.35-2.09V7.07H2.18C1.43 8.55 1 10.22 1 12s.43 3.45 1.18 4.93l2.85-2.22.81-.62z"/>
                  <path fill="#EA4335" d="M12 5.38c1.62 0 3.06.56 4.21 1.64l3.15-3.15C17.45 2.09 14.97 1 12 1 7.7 1 3.99 3.47 2.18 7.07l3.66 2.84c.87-2.6 3.3-4.53 6.16-4.53z"/>
                </svg>
                <span class="font-weight-bold text-body-2">Google</span>
                <v-spacer />
                <v-switch
                  v-model="controller.socialProviders.google.enabled"
                  color="primary"
                  density="compact"
                  hide-details
                  inset
              ...
              <v-text-field
                v-model="controller.socialProviders.google.client_key"
                label="Client ID"
                variant="outlined"
                density="comfortable"
                hide-details
              ...
              <v-text-field
                v-model="controller.socialProviders.google.client_secret"
                label="Client Secret"
                variant="outlined"
                density="comfortable"
                hide-details
              ...
              >
                ...
                Configure o Authorized redirect URI:
                <code>{{ currentOrigin }}/api/oauth2/social/google/callback</code>
              </v-alert>
              ...
              <v-btn
                ...
                rounded="lg"
                class="text-none"
                :loading="controller.savingSocial"
                @click="controller.saveSocialProvider('google')"
              >
              ...
              <v-alert
                v-if="controller.saveSocialError"
                type="error"
                variant="tonal"
                density="compact"
                class="mt-2 text-caption"
                closable
                @click:close="controller.saveSocialError = null"
              >{{ controller.saveSocialError }}</v-alert>

              <v-alert
                v-if="controller.saveSocialSuccess"
                type="success"
                variant="tonal"
                density="compact"
                class="mt-2 text-caption"
                closable
                @click:close="controller.saveSocialSuccess = false"
            ...
            >
              <div class="w-100" style="max-width: 450px">
                ...
                <v-form class="login-form">
                  ...
                  <template v-if="controller.loginConfig.show_social && controller.socialProviders.google.enabled">
                    ...
                    <v-btn
                      ...
                      block
                      rounded="lg"
                      class="text-none social-btn-preview"
                      size="large"
                    >
                      <template v-slot:prepend>
                        <svg width="16" height="16" viewBox="0 0 24 24" style="flex-shrink: 0; display: block">
                          <path fill="#4285F4" d="M22.56 12.25c0-.78-.07-1.53-.2-2.25H12v4.26h5.92c-.26 1.37-1.04 2.53-2.21 3.31v2.77h3.57c2.08-1.92 3.28-4.74 3.28-8.09z"/>
                          <path fill="#34A853" d="M12 23c2.97 0 5.46-.98 7.28-2.66l-3.57-2.77c-.98.66-2.23 1.06-3.71 1.06-2.86 0-5.29-1.93-6.16-4.53H2.18v2.84C3.99 20.53 7.7 23 12 23z"/>
                          <path fill="#FBBC05" d="M5.84 14.09c-.22-.66-.35-1.36-.35-2.09s.13-1.43.35-2.09V7.07H2.18C1.43 8.55 1 10.22 1 12s.43 3.45 1.18 4.93l2.85-2.22.81-.62z"/>
                          <path fill="#EA4335" d="M12 5.38c1.62 0 3.06.56 4.21 1.64l3.15-3.15C17.45 2.09 14.97 1 12 1 7.7 1 3.99 3.47 2.18 7.07l3.66 2.84c.87-2.6 3.3-4.53 6.16-4.53z"/>
                      ...
                      <span class="font-weight-medium" style="color: #3c4043; font-size: 13px">Continue with Google</span>
                    </v-btn>
                  </template>
